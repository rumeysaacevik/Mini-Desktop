 ...
 * @author PC
 */
public class ButtonGradientt extends JButton{
    ...
    private Color color1 = Color.decode("#ad5389");
    private Color color2 = Color.decode("#3c1053");
    ...
    public void changeColor(){
        color1 = Color.decode("#1F1C2C");
        color2 = Color.decode("#928DAB");
    }
